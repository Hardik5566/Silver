<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Inward_Challan_Report.aspx.cs" Inherits="Inward_Challan_Report" %>

<asp:Content ID="c1" ContentPlaceHolderID="title" runat="server">Challan history</asp:Content>
...
<asp:Content ID="c3" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="w-100">
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
            <h1 class="h5 mb-0 fw-semibold text-dark">Challan history</h1>
            <a href="Inward_Challan_List.aspx" class="btn btn-sm btn-outline-primary">Active challans</a>
        </div>
