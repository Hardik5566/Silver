<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Jobwork_Party_Master.aspx.cs" Inherits="Jobwork_Party_Master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="Server">Jobwork party</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="Server">
    ...
    <div class="page-breadcrumb d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3"><i class="bx bx-briefcase">&nbsp;</i>Jobwork party</div>
        <div class="ms-auto">
            <button type="button" class="btn btn-sm btn-primary btn_add" data-bs-toggle="modal" data-bs-target="#modal_jobwork_party">+ Add jobwork party</button>
        </div>
    </div>
            ...
            <div class="row mb-3">
                <div class="col-md-4 col-sm-6">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="txt_jobwork_party_search" class="form-control" placeholder="Party name, contact, mobile, GST..." autocomplete="off" />
                    </div>
                </div>
            </div>
                        ...
                        <asp:TemplateField HeaderText="Action" ItemStyle-Width="100px">
                            <ItemTemplate>
                                <div class="d-flex align-items-center gap-3 fs-6">
                                    <asp:LinkButton CommandName="btn_edit" CommandArgument='<%# Eval("jobwork_party_id") %>' runat="server" CssClass="text-info" title="Edit">
                                        <i class="bi bi-pencil-fill"></i>
                                    </asp:LinkButton>
                                    <asp:LinkButton CommandName="btn_delete" CommandArgument='<%# Eval("jobwork_party_id") %>' runat="server" CssClass="text-danger" title="Delete" OnClientClick="return confirm('Delete this jobwork party?');">
    ...
    <div class="modal fade right" id="modal_jobwork_party" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Jobwork party</h5>
    ...
    <script>
        function validateForm() {
            ...
            if (name.trim() === "") {
                $("#name_Error").text("Party name is required.");
                return false;
            }
            return true;
        }

        function filterJobworkPartyGrid() {
            var value = $("#txt_jobwork_party_search").val().toLowerCase().trim();
        ...
        $(document).ready(function () {
            $("#txt_jobwork_party_search").on("keyup input", filterJobworkPartyGrid);
            filterJobworkPartyGrid();

            $(".btn_add").click(function () {
                $("#<%=hd_action.ClientID%>").val("save");
                $("#<%=hd_party_id.ClientID%>").val("");
        ...
        function showModal() {
            var myModal = new bootstrap.Modal(document.getElementById('modal_jobwork_party'));
            myModal.show();
        }
    </script>
</asp:Content>
