    ...
    <div class="w-100">
        ...
        <div class="inward-card shadow-sm">
            <div class="table-responsive">
                <asp:GridView ID="grid_rpt" runat="server" CssClass="table inward-grid mb-0" AutoGenerateColumns="false" DataKeyNames="jobwork_challan_id"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="" ItemStyle-CssClass="text-end text-nowrap" ItemStyle-Width="88px">
                            <ItemTemplate>
                                <a class="btn btn-sm btn-outline-primary py-0" href='<%# "Jobwork_Challan_Entry.aspx?id=" + Eval("jobwork_challan_id").ToString() %>'>Open</a>
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                </asp:GridView>
